...
import static com.xuqian.admin.common.util.StringUtil.lineToHump;
...
public class MybatisGeneratorUtil {
	...
	// generatorConfig模板路径
	private static String generatorConfig_vm = "classpath:template/generatorConfig.vm";
	// Service模板路径
	private static String service_vm = "classpath:template/Service.vm";
	// ServiceMock模板路径
	private static String serviceMock_vm = "classpath:template/ServiceMock.vm";
	// ServiceImpl模板路径
	private static String serviceImpl_vm = "classpath:template/ServiceImpl.vm";
	...
	public static void generator(
		...
		System.out.println(jdbc_driver+"="+jdbc_url+"="+jdbc_username+"="+jdbc_password+"="+module+"="+database+"="+table_prefix+"="+package_name);
		...
		try {
			...
			// 查询定制前缀项目的所有表
			System.out.println(AESUtil.AESDecode(jdbc_password));
